...
#--- CREATE OBJECT ---------------------------------------------------------------------------------------------------------+
    ...
    # De 9 à 10 si on fait varier la cambrure : jouent sur l'abscisse du point qui définit la cambrure 
        ...
        self.x_min       = np.array([0.005, 0, 0, 0, 0, -0.08, -0.1, -0.1,
         0.3, -0.1])
        self.x_max       = np.array([0.05, 0.07, 0.12, 0.1, 0.15, 0., 0., 0.,  # La cambrure peut bouger de -0.03 à +0.03
         0.8, 0.3]) 
       

        #### Param de mon profil
        self.x_0         = np.array([ 0.02267468,  0.03502696,  0.08531651,  0.08768866,  0.05825892,
                                    -0.05514708, -0.06891857, -0.0253396 ,  0.74175824, -0.00467257])   # Le naca 63215
        self.area        = 0
        self.corde       = 0.131  
        self.angle       = -0.131
        self.area_target = 0.001617           
