...
#--- CREATE OBJECT ---------------------------------------------------------------------------------------------------------+
    ...
    def shape_generation_dussauge(self, control_parameters):
        ...
        ###### On mesh le nouvel airfoil avec extraction 
        ...
        try:
            ...
            point2 = model.geo.addPoint(14, 0, 0, lc)
            point3 = model.geo.addPoint(14, 8, 0, lc)
            point4 = model.geo.addPoint(0, 8, 0, lc)
    ...
    def cfd_solve(self, x, ep):
        ...
        ### convert to .t
        os.system('cd '+self.output_path+'cfd ; python3 gmsh2mtc_1.py')
        ...
        os.system('cd '+self.output_path+'cfd ; python3 gmsh2mtc_2.py')
